          ...
          <Grid container spacing={2} alignItems="center">
            ...
            <Grid item xs>
              <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap" }}>
                <Chip
                  label="All"
                  color={filterRead === null ? "primary" : "default"}
                ...
                <Chip
                  label="Info"
                  color={filterType === "info" ? "primary" : "default"}
                  onClick={() => setFilterType("info")}
                />
                <Chip
                  label="Success"
                  color={filterType === "success" ? "primary" : "default"}
                  onClick={() => setFilterType("success")}
                />
                <Chip
                  label="Warning"
                  color={filterType === "warning" ? "primary" : "default"}
